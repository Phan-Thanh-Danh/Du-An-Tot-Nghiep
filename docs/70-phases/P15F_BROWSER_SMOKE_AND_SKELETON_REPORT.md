...
| Backend build | PASS, 17 warnings, 0 errors |
| Frontend build | PASS |
...
3. Backend build passes but still reports 17 warnings, including the existing `Microsoft.OpenApi` NU1903 advisory plus nullable warnings.
