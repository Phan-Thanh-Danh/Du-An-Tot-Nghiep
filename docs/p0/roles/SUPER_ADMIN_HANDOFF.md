...
## 4. API Endpoints
- **Exact API endpoints**: Check `P0_BACKEND_ENDPOINT_INVENTORY.csv` matching role `SuperAdmin`
- **Proposed API operations**: Check `P0_MISSING_BACKEND_BACKLOG.md`

## 5. UI/UX
- **Wrong-context views**: Ensure no other role's logic leaks into `frontend/src/views/SuperAdmin/`
