...
public class CaHocController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<ApiResponseDto<PagedResultDto<CaHocDto>>>> GetShifts(
    ...
    [HttpGet("active")]
    public async Task<ActionResult<ApiResponseDto<IReadOnlyList<CaHocDto>>>> GetActiveShifts(
        CancellationToken cancellationToken)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var message = shift.ConHoatDong ? "Mở ca học thành công" : "Tắt ca học thành công";
