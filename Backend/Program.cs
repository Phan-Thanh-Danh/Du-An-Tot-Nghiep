...
builder.Services.AddScoped<IGradeAggregationService, GradeAggregationService>();
...
builder.Services.AddScoped<Backend.Services.Finance.IFinanceService, Backend.Services.Finance.FinanceService>();
builder.Services.AddScoped<Backend.Services.Finance.ProgramTuitionConfigs.IProgramTuitionConfigService, Backend.Services.Finance.ProgramTuitionConfigs.ProgramTuitionConfigService>();
builder.Services.AddScoped<Backend.Services.Finance.TuitionPayments.IVietQrService, Backend.Services.Finance.TuitionPayments.VietQrService>();
builder.Services.AddScoped<Backend.Services.Finance.TuitionPayments.ITuitionPaymentService, Backend.Services.Finance.TuitionPayments.TuitionPaymentService>();
...
// =========================================================================
// KHÔNG CHẠY BẤT KỲ SEED C# NÀO KHI KHỞI ĐỘNG (Dữ liệu đã nạp qua SQL Phase 1-5)
// =========================================================================
