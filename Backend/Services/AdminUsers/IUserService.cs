...
public interface IUserService
{
    ...
    Task LockAsync(int userId, string? reason = null, CancellationToken cancellationToken = default);
    Task RevokeSessionsAsync(int userId, CancellationToken cancellationToken = default);
