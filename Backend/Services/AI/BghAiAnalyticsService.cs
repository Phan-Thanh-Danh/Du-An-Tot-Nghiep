...
public class BghAiAnalyticsService : IBghAiAnalyticsService
{
    ...
    public Task<AiCertificateTemplateEditResponse> EditCertificateTemplateWithAiAsync(
        AiCertificateTemplateEditRequest request, CurrentUserContext currentUser,
        CancellationToken cancellationToken = default)
        => CertificatePromptEditor.EditAsync(_ollamaService, request, currentUser, cancellationToken);
