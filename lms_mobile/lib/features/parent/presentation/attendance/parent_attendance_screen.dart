...
class _ParentAttendanceScreenState
  ...
  Future<void> _loadAttendance() async {
    ...
    final data = await repo.getChildAttendance(activeChild.id);
    setState(() {
      _records = data;
      _isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Điểm danh của con'), centerTitle: true),
      body: Column(
        children: [
          const ChildSwitcher(),
          Expanded(
                          ...
                          child: Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    'Tỷ lệ chuyên cần của ${child.fullName}',
