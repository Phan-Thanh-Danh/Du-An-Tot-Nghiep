...
<template>
  <GlassPanel padding="normal" class="h-full flex flex-col hover:border-amber-500/30 transition-colors">
    ...
    <h3 class="font-semibold text-[var(--text-heading)] mb-1 line-clamp-2">{{ reward.tieuDe }}</h3>
    ...
    <div class="mt-4 pt-4 border-t border-[var(--border-card)] grid grid-cols-2 gap-2">
