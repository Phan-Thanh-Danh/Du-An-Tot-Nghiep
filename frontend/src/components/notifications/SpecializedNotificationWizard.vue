  ...
  <GlassPanel variant="strong">
    ...
    <div class="space-y-4">
      <div>
        ...
        <select v-model="type" class="w-full h-10 px-3 rounded-lg border border-(--border-input) bg-(--surface-input)">
      ...
      <div>
        ...
        <textarea v-model="form.ghiChu" class="w-full p-2 rounded-lg border border-(--border-input) bg-(--surface-input)"></textarea>
      </div>
    </div>
