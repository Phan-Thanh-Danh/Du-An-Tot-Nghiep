...
<template>
  ...
  >
    ...
    >
      <div class="lg-sidebar-brand-mark flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-(--radius-lg) bg-gradient-to-tr from-orange-600 to-amber-500">
