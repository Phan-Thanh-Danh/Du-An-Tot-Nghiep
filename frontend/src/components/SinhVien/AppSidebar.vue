  ...
  >
    ...
    <div class="relative space-y-1 border-t border-white/45 px-3 py-3 flex-shrink-0">
      <button
        ...
        :class="[
          'lg-sidebar-item group flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm text-slate-600 focus:outline-none focus:ring-4 focus:ring-blue-500/20',
      ...
      <button
        ...
        :class="[
          'group flex w-full items-center gap-3 rounded-xl border border-transparent px-3 py-2 text-sm text-red-600 transition-all duration-200 hover:border-red-100 hover:bg-red-50/80 hover:shadow-sm focus:outline-none focus:ring-4 focus:ring-red-500/15',
          collapsed ? 'justify-center' : '',
        ]"
