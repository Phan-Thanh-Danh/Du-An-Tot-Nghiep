<script setup>
/**
 * AppSidebar.vue - SuperAdmin
 * ─────────────────────────────────────────────────────────
 * Sidebar dành cho Super Admin.
 * Màu chủ đạo: Violet/Purple (#7c3aed) - phân biệt với các role khác.
 * Tái sử dụng cùng kiến trúc với Layout Sinh viên.
 * ─────────────────────────────────────────────────────────
 */
...
<template>
  <aside
    ...
    :style="{
      '--sidebar-glow-1': 'rgba(124, 58, 237, 0.18)',
      '--sidebar-glow-2': 'rgba(139, 92, 246, 0.12)',
      '--sidebar-glow-dark-1': 'rgba(124, 58, 237, 0.10)',
      '--sidebar-glow-dark-2': 'rgba(139, 92, 246, 0.07)',
      '--sidebar-accent': '#7c3aed',
      '--sidebar-accent-dark': '#a78bfa',
      '--sidebar-indicator': '#7c3aed',
      '--sidebar-focus-ring': 'rgba(124, 58, 237, 0.2)',
      '--active-glow': 'rgba(255, 255, 255, 0.38)',
      '--active-start': '#5b21b6',
      '--active-mid': '#7c3aed',
      '--active-end': '#8b5cf6',
      '--active-shadow-1': 'rgba(91, 33, 182, 0.35)',
      '--active-shadow-2': 'rgba(139, 92, 246, 0.25)',
    }"
  >
    <!-- Ambient glow orbs -->
    <div class="pointer-events-none absolute -left-24 top-24 h-56 w-56 rounded-full bg-violet-300/20 dark:bg-violet-500/8 blur-3xl" />
    <div class="pointer-events-none absolute -bottom-20 right-0 h-60 w-60 rounded-full bg-purple-300/20 dark:bg-purple-500/8 blur-3xl" />
    ...
    <nav class="relative flex-1 space-y-0.5 overflow-y-auto overflow-x-visible px-2 py-2 scrollbar-thin">
      <SidebarMenuGroup
        v-for="group in superAdminMenuGroups"
        :key="group.id"
        :group="group"
        :collapsed="collapsed"
      />
