...
const routeDataRegistry = {
  ...
  '/bgh/schedule/pending': ['/api/bgh/schedules?status=cho_duyet&pageIndex=1&pageSize=50'],
  '/bgh/schedule/conflicts': ['/api/bgh/schedules?pageIndex=1&pageSize=50'],
  '/bgh/schedule/published': ['/api/bgh/schedules?status=da_duyet&pageIndex=1&pageSize=50'],
  '/bgh/schedule/changes': ['/api/bgh/schedule/changes'],
