  ...
  routes: [
    ...
    // ── Teacher Layout (App Shell) ─────────────────────────
    {
      ...
      children: [
        ...
        { path: 'questions/create', name: 'teacher-create-question', component: () => import('../views/GiangVien/CreateQuestionView.vue') },
        { path: 'exams', name: 'teacher-exams', component: () => import('../views/GiangVien/ExamsView.vue') },
        { path: 'exams/create', name: 'teacher-create-exam', component: () => import('../views/GiangVien/CreateExamView.vue') },
