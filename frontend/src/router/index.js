  ...
  routes: [
    ...
    // ── Teacher Layout (App Shell) ─────────────────────────
    {
      ...
      children: [
        ...
        { path: 'class-progress', name: 'teacher-class-progress-list', component: () => import('../views/GiangVien/ClassProgressListView.vue') },
        { path: 'class-progress/:id', name: 'teacher-class-progress-detail', component: () => import('../views/GiangVien/ClassProgressView.vue') },
        ...
        { path: 'assignments', name: 'teacher-assignments-courses', component: () => import('../views/GiangVien/AssignmentCoursesView.vue') , meta: { title: 'Quản lý bài tập' } },
    ...
    // ── Staff Layout (Giáo vụ) ─────────────────────────
    {
      ...
      children: [
        ...
        { path: 'blocks', name: 'staff-blocks', component: () => import('../views/GiaoVu/Schedule/BlockManagementView.vue') , meta: { title: 'Quản lý Block' } },
        { path: 'credit-mappings', name: 'staff-credit-mappings', component: () => import('../views/GiaoVu/Schedule/CreditMappingView.vue') , meta: { title: 'Quy đổi tín chỉ' } },
        ...
        { path: 'schedule/pending', name: 'staff-schedule-pending', component: () => import('../views/GiaoVu/Schedule/PendingSchedulesView.vue') , meta: { title: 'Bản nháp thời khóa biểu' } },
    ...
    // ── BGH Layout (Hiệu trưởng/Ban Giám Hiệu) ────────────────
    {
      ...
      children: [
        ...
        { path: 'academic/pass-fail', name: 'bgh-academic-pass-fail', component: () => import('../views/BGH/Academic/PassFailRatesView.vue'), meta: { title: 'Tỷ lệ Pass/Fail', subtitle: 'Phân tích tỷ lệ đỗ trượt theo môn học và lớp', section: 'Đào tạo & Chương trình' } },
        // Phê duyệt & Đánh giá
        ...
        { path: 'awards', name: 'bgh-awards', component: () => import('../views/SuperAdmin/AwardsView.vue'), meta: { title: 'Quản lý Khen thưởng', subtitle: 'Thiết lập đợt khen thưởng, xét duyệt Top 100 và cấp phát bằng khen', section: 'Phê duyệt & Đánh giá' } },
        { path: 'awards/certificate-templates', name: 'bgh-awards-certificate-templates', component: () => import('../views/SuperAdmin/CertificateTemplatesView.vue'), meta: { title: 'Cấu hình giấy khen', subtitle: 'Quản lý và thiết kế mẫu giấy khen sinh viên', section: 'Phê duyệt & Đánh giá' } },
        { path: 'awards/certificate-templates/new', name: 'bgh-awards-certificate-templates-new', component: () => import('../views/SuperAdmin/CertificateTemplateEditorView.vue'), meta: { title: 'Tạo mẫu giấy khen', subtitle: 'Thiết kế mẫu giấy khen mới cho cơ sở', section: 'Phê duyệt & Đánh giá' } },
        { path: 'awards/certificate-templates/:id/edit', name: 'bgh-awards-certificate-templates-edit', component: () => import('../views/SuperAdmin/CertificateTemplateEditorView.vue'), meta: { title: 'Sửa mẫu giấy khen', subtitle: 'Chỉnh sửa hoặc xem cấu hình mẫu giấy khen', section: 'Phê duyệt & Đánh giá' } },
        // Cơ sở vật chất
