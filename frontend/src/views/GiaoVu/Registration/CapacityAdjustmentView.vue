    ...
    <div class="max-w-4xl mx-auto space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="lg-card-glass p-4 flex flex-col items-center text-center">
          ...
          <div class="h-10 w-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center border-4 border-white shadow-sm mb-3">
        ...
        <div class="lg-card-glass p-4 flex flex-col items-center text-center">
          ...
          <div class="h-10 w-10 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center border-4 border-white shadow-sm mb-3">
             <span class="text-xl font-black">{{ selectedSection.enrolled }}</span>
          </div>
          <p class="text-xs font-bold text-slate-500">Currently enrolled</p>
        </div>
        <div class="lg-card-glass p-4 flex flex-col items-center text-center border-amber-100 bg-amber-50/20">
          <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Đang đợi (Waitlist)</p>
          <div class="h-10 w-10 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center border-4 border-white shadow-sm mb-3">
      ...
      <div class="lg-card-glass p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="bg-slate-50/50 rounded-[24px] p-4 border border-slate-100 space-y-4">
        ...
        <div class="mt-8 flex items-center justify-end gap-4 border-t border-slate-50 pt-6">
           <button class="px-4 py-2.5 text-sm font-bold text-slate-500 hover:text-slate-800 transition-colors">Hủy bỏ</button>
           <button 
             @click="handleAdjust"
