...
<template>
  <div class="space-y-4 pb-10 max-w-7xl mx-auto animate-fade-in">
    <!-- Header -->
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden">
      
      
      <div class="relative z-10 flex items-center gap-5">
        <button @click="router.push('/teacher/classes')" class="h-10 w-10 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-500 hover:text-blue-600 hover:bg-blue-50 border border-slate-100 transition-all">
        ...
        <div>
          ...
          <h1 class="text-xl font-black text-slate-800 tracking-tight">{{ classData.name }}</h1>
        </div>
      </div>
      
      <div class="relative z-10 flex gap-3">
         <router-link :to="`/teacher/classes/${classData.id}/workspace`" class="rounded-[20px] bg-slate-900 px-4 py-3 text-sm font-bold text-white hover:bg-slate-800 transition-all shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
       <!-- Card 1 -->
       <div class="bg-white p-4 rounded-[28px] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-blue-200 transition-colors">
          ...
          <h3 class="text-xl font-black text-slate-800">{{ classData.studentsCount }}</h3>
       ...
       <div class="bg-white p-4 rounded-[28px] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-blue-200 transition-colors">
          ...
          <h3 class="text-xl font-black text-slate-800">{{ classData.upcomingSessions }}</h3>
       ...
       <div class="bg-white p-4 rounded-[28px] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-blue-200 transition-colors">
          ...
          <h3 class="text-xl font-black text-slate-800">{{ classData.pendingAssignments }}</h3>
       ...
       <div class="bg-white p-4 rounded-[28px] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-blue-200 transition-colors">
          ...
          <h3 class="text-xl font-black text-slate-800">{{ classData.averageGpa }}</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
             ...
             <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <router-link to="/teacher/class-progress" class="group flex items-center justify-between p-5 rounded-[24px] border border-slate-100 bg-slate-50 hover:bg-white hover:border-blue-200 hover:shadow-md transition-all">
                   <div class="flex items-center gap-4">
                      <div class="h-10 w-10 rounded-2xl bg-blue-100 text-blue-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <router-link to="/teacher/class-attendance" class="group flex items-center justify-between p-5 rounded-[24px] border border-slate-100 bg-slate-50 hover:bg-white hover:border-blue-200 hover:shadow-md transition-all">
                   <div class="flex items-center gap-4">
                      <div class="h-10 w-10 rounded-2xl bg-cyan-100 text-cyan-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                         <Clock :size="20" />
                      </div>
                      <div>
                ...
                <router-link to="/teacher/class-grades" class="group flex items-center justify-between p-5 rounded-[24px] border border-slate-100 bg-slate-50 hover:bg-white hover:border-blue-200 hover:shadow-md transition-all">
                   <div class="flex items-center gap-4">
                      <div class="h-10 w-10 rounded-2xl bg-indigo-100 text-indigo-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                         <TrendingUp :size="20" />
                      </div>
                      <div>
       ...
       <div class="lg:col-span-1">
          <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm h-full">
             <div class="flex justify-between items-center mb-4">
