...
const savedViewState = sessionStorage.getItem('proctoring_viewState')
const viewState = ref(savedViewState && savedViewState !== 'undefined' ? savedViewState : 'sessions')
const currentTime = ref('')
const savedSessionId = sessionStorage.getItem('proctoring_sessionId')
const selectedSessionId = ref(savedSessionId && savedSessionId !== 'undefined' ? Number(savedSessionId) : '')
